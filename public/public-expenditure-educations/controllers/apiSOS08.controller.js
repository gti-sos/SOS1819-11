...
var datos =[]
app.controller("ApiSOS08", ["$scope", "$http", "$httpParamSerializer", function($scope, $http, $httpParamSerializer) {
    ...
    $http.get("https://sos1819-08.herokuapp.com/api/v1/expenses-of-countries-in-education-and-culture").then(function(response) {
        ...
        for (var i = 0; i < response.data.length; i++) {
            ...
            datos.push({ country: response.data[i].country + " " + response.data[i].year, litres: response.data[i].budgetPercentage});
         
        }
        
        $http.get("https://sos1819-11.herokuapp.com/api/v2/public-expenditure-educations").then(function(response) {
            for (var i = 0; i < 5; i++) {
                datos.push({country: response.data[i].country + " " + response.data[i].year, litres: response.data[i].educationExpensePib});
